...
export function Onboarding() {
  ...
  return (
    <div className="app-frame mx-auto flex min-h-dvh w-full max-w-[430px] flex-col px-5 pt-[calc(env(safe-area-inset-top,0px)+40px)] pb-8">
        ...
        >
          ...
          {step === 2 && (
            <div>
              ...
              <p className="mt-6 mb-1 text-xs text-muted-foreground">Per quante persone spendi?</p>
